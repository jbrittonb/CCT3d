...
def _test_field(g):
    ...
    if u.grid.nsd >= 2:
        ...
        # print('line in x[%d]-direction, starting at %s' %) (direction, u.grid.min_coor)
        print('line in x{:d}-direction, starting at {:s}'.format(direction, u.grid.min_coor))
        print(coor)
        print(u_coor)
        ...
        coor, u_coor, fixed_coor, snapped = \
              u.gridline(u.grid.min_coor, direction)
        if snapped: print('Error: snapped line')
        # print('line in x[%d]-direction, starting at %s' % (direction, point)
        print('line in x{:d}-direction, starting at {:s}'.format(direction, point))
        print(coor)
        print(u_coor)
